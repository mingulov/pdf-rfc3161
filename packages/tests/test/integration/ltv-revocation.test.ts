...
import { timestampPdf, DEFAULT_TSA_CONFIG, KNOWN_TSA_URLS } from "pdf-rfc3161";
...
describe("LTV Revocation Logic", () => {
    ...
    const itLive: typeof it = hasLiveTsa ? it : it.skip;

    let pdfBytes: Uint8Array;

    // Helper to get a TSA URL that may be incompatible
    const getTestTsaUrl = () => KNOWN_TSA_URLS.DIGICERT as string;
