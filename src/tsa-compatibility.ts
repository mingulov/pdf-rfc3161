 ...
 *
 * Testing Notes:
 * - For qualified/EU trust list servers: expect proper RFC 3161 + RFC 5816 compliance
 * - For trusted/Adobe trust list servers: expect RFC 3161 compliance with standard responses
 * - For untrusted servers: may have various quirks, non-standard responses, or missing features
 * - For not working servers: timeouts, errors, or service discontinuation
 */
